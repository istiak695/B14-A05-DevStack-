...
const Banner = () => {
    return (
        <nav className='flex container mx-auto md:flex-block md:justify-between md:items-center md:flex-row flex-col justify-center items-center md:mx-20'>
            <div className="mx-auto my-10 md: text-center">
